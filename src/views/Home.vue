<template>
  <div class="home">
      <img class="city" src="../assets/city.jpg" alt="">
    <div class="image-text">
      <h1>Ukrainian Role Play - НАЙКРАЩИЙ УКРАЇНСЬКИЙ СЕРВЕР В SAMP ІНДУСТРІЇ.</h1>
      <button class="btn" @click="isOpen = true">ПОЧАТИ ГРУ</button>
